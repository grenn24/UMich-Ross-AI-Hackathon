        ...
        <div className="viz-panel">
            ...
            {recommendation && (
                <div className="rec-box">
                    <strong>PulseAI Strategy Insight:</strong> ECON 401 has 3 deadlines converging Nov 14. Move Assignment 3 by 5 days and pressure drops 34 points. Affects 12 at-risk students.
