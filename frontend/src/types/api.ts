...
export interface OracleShowcaseResponse {
	...
	languageService: {
		...
		description: string;
		input: string;
		outputs: Array<{ key: string; value: string; tone: "critical" | "warning" | "stable" | "accent" | "neutral" }>;
	...
	mlService: {
		...
		weightedBreakdown: {
			pressure: Array<{ key: string; value: string; tone: "critical" | "warning" | "stable" | "accent" | "neutral" }>;
			resilience: Array<{ key: string; value: string; tone: "critical" | "warning" | "stable" | "accent" | "neutral" }>;
		};
	};
	databaseService: {
		badge: string;
	...
	assistantService: {
		...
		title: string;
		description: string;
		context: Array<{ key: string; value: string; tone: "critical" | "warning" | "stable" | "accent" | "neutral" }>;
		emailPreview: string;
	};
	scaleStats: Array<{ value: string; label: string }>;
}
